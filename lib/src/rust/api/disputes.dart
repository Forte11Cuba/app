...
// These functions are ignored because they are not marked as `pub`: `all`, `clear_dispute_keys`, `derive_admin_shared_key`, `dispute_store`, `forget_identity_disputes`, `get`, `has_dispute_keys`, `is_order_finished`, `is_peer_placeholder`, `new`, `pending_opens`, `persist_admin_pubkey`, `persist_dispute_origin`, `persisted_order_is_finished`, `record_late_acceptance`, `rehydrate_disputes_from_storage`, `resolve_dispute`, `resubscribe_active_dispute_chats`, `solver_pubkey`, `status_allows_dispute`, `try_insert_if_absent_or_resolved`, `update_conditional`, `upsert_or_update`
